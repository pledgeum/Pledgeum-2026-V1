                    ...
                    <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <div className="md:col-span-2">
                            ...
                            <select
                                ...
                                className="mt-1 block w-full rounded-md border-gray-400 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 sm:text-sm p-2 border text-gray-900 disabled:opacity-100 disabled:text-gray-900"
                            >
                                ...
                                <div className="flex gap-2">
                                    <div className="relative flex-1">
                                        <input
                                            ...
                                            className="mt-1 block w-full rounded-md border-gray-400 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-200 sm:text-sm p-2 border pr-10 bg-blue-50 placeholder:text-gray-500 text-gray-900 disabled:opacity-100 disabled:text-gray-900"
                                        />
                                        {isSearchingSiret && (
                            ...
                            <div>
                                ...
                                <div className="mt-1 relative rounded-md shadow-sm max-w-xs">
                                    <input
                                        ...
                                        placeholder="0"
                                        className={cn(
                                            "block w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border pr-16 text-gray-900",
