                        ...
                        <div className="md:col-span-2">
                            ...
                            <div className="flex items-center space-x-4 mt-1">
                                <input
                                    ...
                                    readOnly
                                    value={totalHours}
                                    className="block w-32 rounded-md border-gray-300 bg-gray-100 shadow-sm focus:border-gray-500 focus:ring-0 sm:text-sm p-2 border font-bold text-blue-900"
                                />
                                {/* Progress Bar */}
